...
<html>
    ...
    <body>
            ...
            <tbody>
                <tr>
                    ...
                    <td width="15%">                        
                        ...
                        echo '<div style="line-height:25px;">' . Yii::app()->dateFormatter->format("d.MM.y", $order->date_reciept) . '</div>';
                        ?>
                    </td>
                </tr>
            </tbody>
        ...
        <table style="line-height:0em;">
            <tr>
                <td >
                    ...
                    <div style="line-height: 6em;">Телефон: <strong><?php echo $order->Customer->phone; ?></strong></div>
                </td>
                <td>
        ...
        <p style="border-top:1px solid #999;line-height:15em;"></p>
        ...
        <table>
            <tr>
                <td width="70%">С примерной калькуляцией и оплатой диагностики согласен (на)</td>
                <td width="30%">
                    ____________ ( подпись заказчика )</td>
            </tr>
        </table>
...
<p><strong>Оборудование мной получено и проверено. </strong><br/><br/>
...
<table>
    <tr>
        ...
        <td width="15%">
            <?php $pdf->write1DBarcode($order->id, 'C128B', 160, 201, 30, 7, 5, $style); ?>
            <?php echo '<div style="line-height:20em;">' . Yii::app()->dateFormatter->format("d.MM.y", $order->date_reciept).'</div>'; ?>
        </td>
    </tr>
</table>
<table>
